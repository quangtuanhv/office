				...
				<div class="panel-body">
					<div class="row">
						<div id="data" style="margin: 10px;" >
							<form action="{{route('luuvanban',0)}}" method="POST">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
											...
											<select name="coquanbanhanh" class="form-control">
												@foreach($dv as $dv)
												<option value="{{$dv->tenDonVi}}">{{$dv->tenDonVi}}</option>
												@endforeach
											</select>
										</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
											...
											<select name="nguoiky" class="form-control">
												@foreach($nk as $nk)
